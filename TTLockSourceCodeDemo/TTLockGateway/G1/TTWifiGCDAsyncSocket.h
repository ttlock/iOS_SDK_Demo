...
@interface TTWifiGCDAsyncSocket : NSObject
...
**/
- (nullable dispatch_queue_t)newSocketQueueForConnectionFromAddress:(NSData *)address onSocket:(TTWifiGCDAsyncSocket *)sock;
...
**/
- (void)socket:(TTWifiGCDAsyncSocket *)sock didAcceptNewSocket:(TTWifiGCDAsyncSocket *)newSocket;
 ...
 * The host parameter will be an IP address, not a DNS name.
 **/
- (void)socket:(TTWifiGCDAsyncSocket *)sock didConnectToUrl:(NSURL *)url;
...
**/
- (void)socket:(TTWifiGCDAsyncSocket *)sock didReadPartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;
 ...
 * It may be used to for things such as updating progress bars.
**/
- (void)socket:(TTWifiGCDAsyncSocket *)sock didWritePartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;
...
**/
- (NSTimeInterval)socket:(TTWifiGCDAsyncSocket *)sock shouldTimeoutReadWithTag:(long)tag
...
**/
- (NSTimeInterval)socket:(TTWifiGCDAsyncSocket *)sock shouldTimeoutWriteWithTag:(long)tag
                                                                  elapsed:(NSTimeInterval)elapsed
                                                                bytesDone:(NSUInteger)length;
...
**/
- (void)socketDidCloseReadStream:(TTWifiGCDAsyncSocket *)sock;
...
**/
- (void)socketDidDisconnect:(TTWifiGCDAsyncSocket *)sock withError:(nullable NSError *)err;
...
**/
- (void)socketDidSecure:(TTWifiGCDAsyncSocket *)sock;
...
**/
- (void)socket:(TTWifiGCDAsyncSocket *)sock didReceiveTrust:(SecTrustRef)trust

...
{
    TTPassageModeTypeWeek = 1,
    TTPassageModeTypeDay = 2,
    TTPassageModeTypeMonthAndDay = 3,
};
...
typedef NS_ENUM(long long, TTLockSpecialFunction)
{
    ...
    TTLockSpecialFunctionUpgradeFirmware = 1 << 6,
